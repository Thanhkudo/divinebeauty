            ...
            <div class="e-con-inner">
                <div class="elementor-element elementor-element-788abe9 e-con-full e-con" data-id="788abe9"
                    ...
                    <?php if($block_childs): ?>
                        <?php $__currentLoopData = $block_childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="elementor-element elementor-element-5aa99c5 e-con-full e-con"
                                            ...
                                            <div class="elementor-element elementor-element-fa19cb8 elementor-widget elementor-widget-image"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <img width="1140" height="760" src="<?php echo e($image_child2); ?>"
                                                        class="attachment-full size-full wp-image-1405"
                                                        alt="4V7A7453 - Ariel Medical - Aesthetic Clinic | GREECE"
                                                        decoding="async" loading="lazy" srcset="<?php echo e($image_child2); ?>"
                                                        sizes="(max-width: 1140px) 100vw, 1140px"
                                                        title="<?php echo e($title_child2); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    <?php else: ?>
                            ...
                            <?php endif; ?>
                            <?php if($image_background_child != null): ?>
                ...
                <div class="elementor-element elementor-element-bb8535d e-con-full e-con" data-id="bb8535d"
                    ...
                    <div class="elementor-element elementor-element-20cd20d animated-slow elementor-invisible elementor-widget elementor-widget-heading"
                        ...
                        <div class="elementor-widget-container">
                            <h5 class="elementor-heading-title elementor-size-default"><?php echo e($brief); ?></h5>
                        </div>
                    </div>
                                        ...
                                        <div class="elementskit-box-header">
                                            <div class="elementskit-info-box-icon ">
                                                <img decoding="async" width="227" height="256"
                                                    ...
                                                    loading="lazy" title="<?php echo e($title); ?>">
                                            </div>
                                        </div>
                                        <div class="box-body">
                                        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\spa\resources\views/frontend/blocks/about_us/styles/default.blade.php ENDPATH**/ ?>