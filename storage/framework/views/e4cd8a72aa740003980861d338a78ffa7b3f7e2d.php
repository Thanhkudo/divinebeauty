                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                placeholder="<?php echo app('translator')->get('Name'); ?>" value="<?php echo e(old('name') ?? ($detail->json_params->name->$lang ?? ($detail->name??""))); ?>"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\spa\resources\views/admin/pages/pages/edit.blade.php ENDPATH**/ ?>