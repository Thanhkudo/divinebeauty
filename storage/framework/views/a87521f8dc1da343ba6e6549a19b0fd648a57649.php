...
<div id="button-contact-vr">
    ...
    <div class="phone-vr">
      <div class="phone-vr-img-circle">
        <a target="_blank" href="<?php echo e($web_information->social->zalo); ?>">
          <img src="<?php echo e(asset('images/zalo-icon.png')); ?>" alt="zalo"/>
        </a>
      </div>
    </div>
  </div>
  <!-- end zalo -->
  <?php endif; ?>
  <?php if(isset($web_information->social->messenger) && $web_information->social->messenger != ''): ?>
    <!-- Phone -->
...
<?php /**PATH C:\xampp\htdocs\spa\resources\views/frontend/components/sticky/contact.blade.php ENDPATH**/ ?>