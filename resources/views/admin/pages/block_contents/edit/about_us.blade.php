                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="brief" id="brief" class="form-control" rows="5">{{ old('brief') ?? ($detail->json_params->brief->$lang??( $detail->json_params->brief->$lang ?? $detail->brief)) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>@lang('Content')</label>
                                            <textarea name="content" id="content" class="form-control" rows="5">{{ old('content') ?? ($detail->json_params->content->$lang??( $detail->json_params->content->$lang ?? $detail->content)) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                                                    ...
                                                                    <div class="tab-pane active">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>@lang('Brief')</label>
                                                                                    <textarea name="brief" id="brief" class="form-control" rows="5">{{ old('brief') ?? ($item->json_params->brief->$lang??$item->brief) }}</textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>@lang('Content')</label>
                                                                                    <textarea name="content" id="content" class="form-control" rows="5">{{ old('content') ?? ($item->json_params->content->$lang??$item->content) }}</textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text"
                                                                                        ...
                                                                                        name="url_link_title"
                                                                                        placeholder="@lang('Url redirect title')"
                                                                                        value="{{ old('url_link_title') ??( $item->json_params->url_link_title->$lang ?? $item->url_link_title) }}">
                                                                                </div>
                                                                            </div>
