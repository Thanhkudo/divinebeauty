                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title"
                                                placeholder="@lang('Title')" value="{{ $detail->json_params->title->$lang ?? $detail->title }}" required>
                                        </div>

                                        <div class="form-group">
                                            <label>@lang('Order')</label>
                                            <input type="number" class="form-control" name="iorder"
                                                placeholder="@lang('iorder')" value="{{ $detail->iorder }}">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="json_params[description][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]" class="form-control" rows="5">{{ $detail->json_params->description->$lang ?? old('json_params[description]['.$lang != "" ? $lang : $languageDefault->lang_code.']') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>@lang('Brief')</label>
                                            <textarea name="json_params[brief][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]" class="form-control" rows="5">{{ $detail->json_params->brief->$lang ?? old('json_params[brief]['.$lang != "" ? $lang : $languageDefault->lang_code.']') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea name="json_params[content][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]" class="form-control" id="content_vi">{{ $detail->json_params->content->$lang ?? old('json_params[content]['.$lang != "" ? $lang : $languageDefault->lang_code.']') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
