                ...
                <div class="elementor-widget-wrap elementor-element-populated">
                  <div class="elementor-element elementor-element-278e165 elementor-widget elementor-widget-image"
                    ...
                    <div class="elementor-widget-container">
                      <img width="800" height="251" src="{{ $web_information->image->logo_footer ?? '' }}"
                        ...
                        @isset($web_information->social->instagram)
                          <span class="elementor-grid-item">
                            <a class="elementor-icon elementor-social-icon elementor-social-icon-instagram elementor-animation-shrink elementor-repeater-item-63f86db"
                              href="{{ $web_information->social->instagram }}" target="_blank">
                              ...
                              @foreach ($footer_menu_child as $item_child)
                                <li class="elementor-icon-list-item">
                                  <a href="{{ $item_child->url_link }}">
                                    <span
                                      class="elementor-icon-list-text">{{ $item_child->json_params->name->{$locale} ?? $item_child->name }}</span>
                                  </a>
                                </li>
                              @endforeach
                            @endisset
                      ...
                      <ul class="elementor-icon-list-items">
                        <li class="elementor-icon-list-item">
                          <a href="mailto:{{ $web_information->information->email }}">
                            ...
                            <span class="elementor-icon-list-text">{{ $web_information->information->email }}</span>
                          </a>
                        </li>
                      </ul>
                    </div>
                      ...
                      <ul class="elementor-icon-list-items">
                        <li class="elementor-icon-list-item">
                          <a href="tel:{{ $web_information->information->phone }}">
                            ...
                            <span class="elementor-icon-list-text">{{ $web_information->information->phone }}</span>
                          </a>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div class="elementor-widget-container">
                      <ul class="elementor-icon-list-items">
                        <li class="elementor-icon-list-item">
                          ...
                          <span class="elementor-icon-list-text">{{ $web_information->information->address }}</span>
                        </li>
                      </ul>
                    </div>
                  </div>
