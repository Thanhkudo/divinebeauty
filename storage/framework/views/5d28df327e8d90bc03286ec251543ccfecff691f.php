  ...
  <section class="content">
      ...
      <form action="<?php echo e(route(Request::segment(2) . '.index')); ?>" method="GET">
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label><?php echo app('translator')->get('Service category'); ?></label>
    ...
    <div class="box">
      <div class="box-header">
        <h3 class="box-title"><?php echo app('translator')->get('Services list'); ?></h3>
      </div>
          ...
          <table class="table table-hover table-bordered">
            <thead>
              <tr>
                ...
                <th><?php echo app('translator')->get('Service category'); ?></th>
                ...
                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      ...
                      <?php
                        $url_mapping = App\Helpers::generateRoute(App\Consts::TAXONOMY['service'], $row->alias ?? $row->title, $row->id, 'detail', $row->taxonomy_title);
                      ?>
                      <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\spa\resources\views/admin/pages/cms_services/index.blade.php ENDPATH**/ ?>