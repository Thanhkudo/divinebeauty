                            ...
                            <div class="elementor-icon-box-wrapper">
                                <div class="elementor-icon-box-icon">
                                    <a class="elementor-icon elementor-animation-"
                                        href="tel:<?php echo e($web_information->information->phone ?? ''); ?>">
                    ...
                    <div class="elementor-element elementor-element-18f68b1 elementor-view-framed elementor-position-left elementor-vertical-align-middle elementor-mobile-position-left elementor-shape-circle elementor-widget elementor-widget-icon-box"
                        ...
                        <div class="elementor-widget-container">
                            <div class="elementor-icon-box-wrapper">
                                <div class="elementor-icon-box-icon">
                                    <a class="elementor-icon elementor-animation-"
                                        href="<?php echo e($web_information->information->map ?? '#'); ?>">
                                        <i aria-hidden="true" class="icon icon-map-marker1"></i>
                                    </a>
                                </div>
                                <div class="elementor-icon-box-content">
                                    <h4 class="elementor-icon-box-title">
                                        <a href="<?php echo e($web_information->information->map ?? '#'); ?>">
                                ...
                                <?php if($block_childs): ?>
                                    <?php $__currentLoopData = $block_childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <li class="elementor-icon-list-item">
                                            ...
                                            <span class="elementor-icon-list-text"><?php echo e($title_childs); ?></span>
                                        </li>
                            ...
                            <div class="elementor-form-fields-wrapper elementor-labels-above">
                                ...
                                <div
                                    ...
                                    <input size="1" type="tel" name="phone" id="form-field-phone"
                                        class="elementor-field elementor-size-md elementor-field-textual"
                                        placeholder="<?php echo app('translator')->get('Phone'); ?>" pattern="^[0-9\-\+]{9,15}$"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\spa\resources\views/frontend/blocks/form/styles/booking.blade.php ENDPATH**/ ?>