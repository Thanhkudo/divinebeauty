                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                placeholder="<?php echo app('translator')->get('Name'); ?>" value="<?php echo e(old('name')); ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="og_image" class="form-control" type="text"
                                                    ...
                                                    value="<?php echo e(old('json_params[og_image]')); ?>">
                                            </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function check_nestb() {
            ...
            console.log($('#nastb_selected').nestable('serialize'));
            console.log($('#nastb_available').nestable('serialize'));
            return true;
        }
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\spa\resources\views/admin/pages/pages/create.blade.php ENDPATH**/ ?>