<?php if($block): ?>
    ...
    <div class="elementor-element elementor-element-93ab316 e-con-full e-con" data-id="93ab316"
        ...
        <div class="elementor-element elementor-element-7fcacd82 e-con-full e-con" data-id="7fcacd82"
            ...
            data-e-bg-lazyload=""
            style="background-image: url('<?php echo e($image_background); ?>');
                                                    ...
                                                    <div class="bio-details">
                                                        <div class="profile-image">
                                                            <img decoding="async" src="<?php echo e($image_child); ?>"
                                                                alt="<?php echo e($title_child); ?>" title="<?php echo e($title_child); ?>" />
                                                        </div>
                                                        <span class="profile-info">
                                                            <strong class="profile-name"><?php echo e($title_child); ?></strong>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\spa\resources\views/frontend/blocks/custom/styles/about_client.blade.php ENDPATH**/ ?>