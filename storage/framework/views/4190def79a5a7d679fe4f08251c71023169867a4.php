<?php if($block): ?>
    ...
    <div class="elementor-278">
        <div class="elementor-element elementor-element-ac8b1e4 e-con-boxed e-con" data-id="ac8b1e4"
            ...
            data-e-bg-lazyload=""
            style="background: url(<?php echo e($background); ?>);
                    ...
                    <div class="elementor-element elementor-element-e4147d4 elementor-widget elementor-widget-heading"
                        ...
                        <div class="elementor-widget-container">
                            <h4 class="elementor-heading-title elementor-size-default">
                                <?php echo app('translator')->get('Opening Hours'); ?>
                            </h4>
                        </div>
                    </div>
                    <?php if($block_childs): ?>
                        <?php $__currentLoopData = $block_childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           ...
                           <div class="elementor-element elementor-element-23eb752 e-con-full e-con" data-id="23eb752"
                               ...
                               <div class="elementor-element elementor-element-f8aec51 elementor-widget elementor-widget-heading"
                                   ...
                                   <div class="elementor-widget-container">
                                       <span class="elementor-heading-title elementor-size-default"><?php echo e($title_childs); ?></span>
                                   </div>
                               </div>
                           </div>
                                       ...
                                       <ul class="elementor-icon-list-items elementor-inline-items">
                                           <li class="elementor-icon-list-item elementor-inline-item">
                                               <span class="elementor-icon-list-icon">
                                                   <i aria-hidden="true" class="<?php echo e($icon_childs); ?>"></i>
                                               </span>
                                               <span class="elementor-icon-list-text"><?php echo e($contact_childs); ?></span>
                                           </li>
                                       </ul>
                                   </div>
                               </div>
                                ...
                                <div class="elementor-form-fields-wrapper elementor-labels-above">
                                    ...
                                    <div
                                        ...
                                        <input size="1" type="email" name="email" id="form-field-email"
                                            class="elementor-field elementor-size-md elementor-field-textual"
                                            placeholder="<?php echo app('translator')->get('Email'); ?>" required="required"
                                            aria-required="true" />
                                    </div>
                                    <div
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\spa\resources\views/frontend/blocks/form/styles/booknow.blade.php ENDPATH**/ ?>