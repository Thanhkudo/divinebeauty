                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                                ...
                                                @foreach ($parents as $item)
                                                    @if ($item->parent_id == 0 || $item->parent_id == null)
                                                        <option value="{{ $item->id }}"
                                                            {{ $detail->taxonomy_id == $item->id ? 'selected' : '' }}>
                                                            {{ $item->title }}</option>

                                                        @foreach ($parents as $sub)
                                                            @if ($item->id == $sub->parent_id)
                                                                <option value="{{ $sub->id }}"
                                                                    {{ $detail->taxonomy_id == $sub->id ? 'selected' : '' }}>
                                                                    - - {{ $sub->title }}
                                                                </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title"
                                                ...
                                                value="{{ $detail->json_params->title->$lang ?? $detail->title }}"
                                                required>
                                        </div>

                                        <div class="form-group">
                                            <label>@lang('Icon') </label>
                                            <input type="text" class="form-control" name="json_params[icon]"
                                                placeholder="@lang('Icon')"
                                                value="{{ $detail->json_params->icon ?? '' }}">
                                        </div>
                                            ...
                                            <div class="form-control">
                                                ...
                                                <label>
                                                    <input type="radio" name="is_featured" value="0"
                                                        class="ml-15" {{ $detail->is_featured == '0' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="json_params[description][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]"
                                                class="form-control" rows="5">{{ isset($detail->json_params->description->$lang) ? $detail->json_params->description->$lang : old('json_params[brief][' . $lang != '' ? $lang : $languageDefault->lang_code . ']') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="json_params[brief][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]" class="form-control"
                                                rows="5">{{ isset($detail->json_params->brief->$lang) ? $detail->json_params->brief->$lang : old('json_params[brief][' . $lang != '' ? $lang : $languageDefault->lang_code . ']') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea name="json_params[content][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]" class="form-control"
                                                    id="content_vi">{{ isset($detail->json_params->content->$lang) ? $detail->json_params->content->$lang : old('json_params[content][' . $lang != '' ? $lang : $languageDefault->lang_code . ']') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
