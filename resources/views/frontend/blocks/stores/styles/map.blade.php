    ...
    @if ($block_childs)
        ...
        @foreach ($block_childs as $items)
            ...
            <div class="elementor-element elementor-element-70da773d e-con-boxed e-con" data-id="70da773d"
                ...
                <div class="e-con-inner border border-{{ $loop->index }}">
            ...
            <div class="e-con-inner">
                <div class="block_map">
                    <div class="box_address">
                        <div class="content">
                            @foreach ($arr_map as $item_map)
                                <div class="iframe_element" data="{{ $item_map->json_params->map ?? '' }}">
                                    <div class="title">
                                        {{ $item_map->json_params->title->{$locale} ?? $item_map->title }}</div>
                                    <hr>
                                    <p>{!! nl2br($brief = $item_map->json_params->brief->{$locale} ?? $item_map->brief) !!}</p>
                                </div>
                            @endforeach
                        </div>
                    </div>
                    <div class="box_map">
                        {!! $arr_map[0]->json_params->map ?? '' !!}
                    </div>
                </div>
            </div>
        </div>
