@if ($block)
                                    ...
                                    @if ($gallery)
                                        @foreach ($gallery as $item)
                                            <a class="e-gallery-item elementor-gallery-item elementor-animated-content"
                                                href="{{ $item }}" data-elementor-open-lightbox="yes"
                                                ...
                                                <div class="e-gallery-image elementor-gallery-item__image"
                                                    data-thumbnail="{{ $item }}" data-width="500"
    ...
    <script src="{{ url('themes/frontend/wp-content/plugins/elementor-pro/assets/js/gallery.min.js') }}?ver=1.2.0"></script>
