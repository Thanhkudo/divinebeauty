        ...
        <div class="box-body">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="block_code" placeholder="<?php echo app('translator')->get('block_code'); ?>"
                value="<?php echo e(old('block_code')); ?>" required>
            </div>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <textarea name="json_params" id="json_params" class="form-control" rows="10"><?php echo e(old('json_params')); ?></textarea>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\spa\resources\views/admin/pages/blocks/create.blade.php ENDPATH**/ ?>