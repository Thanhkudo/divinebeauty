                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" id="content" class="form-control" rows="5"><?php echo e(old('content')); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="url_link_title"
                                                placeholder="<?php echo app('translator')->get('Url redirect title'); ?>" value="<?php echo e(old('url_link_title')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="image_background-holder" style="margin-top:15px;max-height:100px;">
                                                <?php if(old('image_background') != ''): ?>
                                                    <img style="height: 5rem;" src="<?php echo e(old('image_background')); ?>">
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\spa\resources\views/admin/pages/block_contents/create.blade.php ENDPATH**/ ?>