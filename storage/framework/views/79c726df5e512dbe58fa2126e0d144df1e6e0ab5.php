                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title"
                                                placeholder="<?php echo app('translator')->get('Title'); ?>" value="<?php echo e($detail->json_params->title->$lang??$detail->title); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="json_params[price]"
                                                placeholder="<?php echo app('translator')->get('Price'); ?>" value="<?php echo e($detail->json_params->price??''); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="json_params[brief][<?php echo e($lang); ?>]" class="form-control" id="brief_vi" ><?php echo e(isset($detail->json_params->brief->$lang) ? $detail->json_params->brief->$lang : old('json_params[brief][' . $lang . ']')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="json_params[description][<?php echo e($lang); ?>]" class="form-control" id="description_vi" ><?php echo e(isset($detail->json_params->description->$lang) ? $detail->json_params->description->$lang : old('json_params[description][' . $lang . ']')); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea name="json_params[content][<?php echo e($lang); ?>]" class="form-control" id="content_vi"><?php echo e(isset($detail->json_params->content->$lang) ? $detail->json_params->content->$lang : old('json_params[content][' . $lang . ']')); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea name="json_params[information][<?php echo e($lang); ?>]" class="form-control" id="information_vi"><?php echo e(isset($detail->json_params->information->$lang) ? $detail->json_params->information->$lang : old('json_params[information][' . $lang . ']')); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea name="json_params[using][<?php echo e($lang); ?>]" class="form-control" id="using_vi"><?php echo e(isset($detail->json_params->using->$lang) ? $detail->json_params->using->$lang : old('json_params[using][' . $lang . ']')); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\spa\resources\views/admin/pages/cms_products/edit.blade.php ENDPATH**/ ?>