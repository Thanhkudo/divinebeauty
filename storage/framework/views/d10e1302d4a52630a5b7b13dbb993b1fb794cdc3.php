        ...
        <div class="elementor-widget-wrap elementor-element-populated">
          <section
            ...
            <div class="elementor-container elementor-column-gap-no">
              <div
                class="elementor-column elementor-col-25 elementor-inner-column elementor-element elementor-element-325eb0d7"
                data-id="325eb0d7" data-element_type="column" data-settings='{"background_background":"classic"}'>
                <div class="elementor-widget-wrap elementor-element-populated">
                  <div class="elementor-element elementor-element-278e165 elementor-widget elementor-widget-image"
                    ...
                    <div class="elementor-widget-container">
                      <img width="800" height="251" src="<?php echo e($web_information->image->logo_footer ?? ''); ?>"
                        class="attachment-full size-full wp-image-291" alt="" decoding="async" loading="lazy"
                        srcset="<?php echo e($web_information->image->logo_footer ?? ''); ?>"
                        sizes="(max-width: 800px) 100vw, 800px" />
                    </div>
                  </div>
                  <div
                    class="elementor-element elementor-element-2748dfde elementor-widget elementor-widget-text-editor"
                    data-id="2748dfde" data-element_type="widget" data-widget_type="text-editor.default">
                    <div class="elementor-widget-container">
                      <p>
                  ...
                  <div
                    class="elementor-element elementor-element-3513618a elementor-shape-circle e-grid-align-left e-grid-align-tablet-left elementor-grid-0 elementor-widget elementor-widget-social-icons"
                    data-id="3513618a" data-element_type="widget" data-widget_type="social-icons.default">
                    <div class="elementor-widget-container">
                        ...
                        <?php if(isset($web_information->social->instagram)): ?>
                          <span class="elementor-grid-item">
                            <a class="elementor-icon elementor-social-icon elementor-social-icon-instagram elementor-animation-shrink elementor-repeater-item-63f86db"
                              href="<?php echo e($web_information->social->instagram); ?>" target="_blank">
              ...
              <?php if(isset($menu)): ?>
                ...
                <?php $__currentLoopData = $footer_menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  ?>
                  <div
                    class="elementor-column elementor-col-25 elementor-inner-column elementor-element elementor-element-3f875f18"
                    ...
                    <div class="elementor-widget-wrap elementor-element-populated">
                      <div class="elementor-element elementor-element-7e015939 elementor-widget elementor-widget-heading"
                        data-id="7e015939" data-element_type="widget" data-widget_type="heading.default">
                        <div class="elementor-widget-container">
                      ...
                      <div
                        class="elementor-element elementor-element-1c5845b5 elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list"
                        data-id="1c5845b5" data-element_type="widget" data-widget_type="icon-list.default">
                        <div class="elementor-widget-container">
                              ...
                              <?php $__currentLoopData = $footer_menu_child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="elementor-icon-list-item">
                                  <a href="<?php echo e($item_child->url_link); ?>">
                                    <span
                                      class="elementor-icon-list-text"><?php echo e($item_child->json_params->name->{$locale} ?? $item_child->name); ?></span>
                                  </a>
                                </li>
              ...
              <div
                class="elementor-column elementor-col-25 elementor-inner-column elementor-element elementor-element-5c980ef7"
                ...
                <div class="elementor-widget-wrap elementor-element-populated">
                  <div class="elementor-element elementor-element-56f044ad elementor-widget elementor-widget-heading"
                    data-id="56f044ad" data-element_type="widget" data-widget_type="heading.default">
                    <div class="elementor-widget-container">
                      <h4 class="elementor-heading-title elementor-size-default">
                  ...
                  <div
                    class="elementor-element elementor-element-3c90e9d7 elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list"
                    data-id="3c90e9d7" data-element_type="widget" data-widget_type="icon-list.default">
                    <div class="elementor-widget-container">
                      <ul class="elementor-icon-list-items">
                        <li class="elementor-icon-list-item">
                          <a href="mailto:<?php echo e($web_information->information->email); ?>">
                            ...
                            <span class="elementor-icon-list-text"><?php echo e($web_information->information->email); ?></span>
                          </a>
                        </li>
                      </ul>
                    </div>
                  ...
                  <div
                    class="elementor-element elementor-element-601d323 elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list"
                    data-id="601d323" data-element_type="widget" data-widget_type="icon-list.default">
                    <div class="elementor-widget-container">
                      <ul class="elementor-icon-list-items">
                        <li class="elementor-icon-list-item">
                          <a href="tel:<?php echo e($web_information->information->phone); ?>">
                            ...
                            <span class="elementor-icon-list-text"><?php echo e($web_information->information->phone); ?></span>
                          </a>
                        </li>
                      </ul>
                    </div>
                  ...
                  <div
                    class="elementor-element elementor-element-d732653 elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list"
                    data-id="d732653" data-element_type="widget" data-widget_type="icon-list.default">
                    <div class="elementor-widget-container">
                      <ul class="elementor-icon-list-items">
                        <li class="elementor-icon-list-item">
                          <span class="elementor-icon-list-icon">
                          ...
                          <span class="elementor-icon-list-text"><?php echo e($web_information->information->address); ?></span>
                        </li>
                      </ul>
                    </div>
                  </div>
