                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="json_params[description][{{$lang}}]" class="form-control" rows="5">{{ old('json_params[description]['.$lang.']') ?? ($detail->json_params->description->$lang ?? '') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <li class="dd-item dd3-item " data-id="{{ $items->id }}">
                                                ...
                                                <div class="dd3-content">
                                                    <span class="text float-start"
                                                        data-update="title">{{ ( $items->json_params->title->$lang ?? $items->title) }}</span>
                                                    <span class="text float-end">@lang($status[$items->status])</span>
                                                    <a data-toggle="collapse" href="#item-details-{{ $items->id }}"
                                                        role="button" aria-expanded="false"
                                                        aria-controls="item-details-{{ $items->id }}"
                                                ...
                                                <div class="item-details collapse multi-collapse form-block"
                                                    id="item-details-{{ $items->id }}">
                                                    <form role="form"
                                                        action="{{ route(Request::segment(2) . '.update', $items->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        @if (Request::get('lang') != '' && Request::get('lang') != $languageDefault->lang_locale)
                                                                    ...
                                                                    <div class="tab-pane active">
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text"
                                                                                        ...
                                                                                        name="title"
                                                                                        placeholder="@lang('Title')"
                                                                                        value="{{ old('title') ?? ( $items->json_params->title->$lang ?? $items->title) }}"
                                                                                        required>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>@lang('Brief')</label>
                                                                                    <textarea name="brief" class="form-control" rows="5">{{ old('brief') ?? ( $items->json_params->brief->$lang ?? $items->brief) }}</textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>@lang('Content')</label>
                                                                                    <textarea name="content" class="form-control" rows="5">{{ old('content') ?? ( $items->json_params->content->$lang ?? $items->content) }}</textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text"
                                                                                        ...
                                                                                        name="url_link"
                                                                                        placeholder="@lang('Url redirect')"
                                                                                        value="{{ old('url_link') ?? $items->url_link }}">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text"
                                                                                        ...
                                                                                        name="url_link_title"
                                                                                        placeholder="@lang('Url redirect title')"
                                                                                        value="{{ old('url_link_title') ?? ( $items->json_params->url_link_title->$lang ?? $items->url_link_title) }}">
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select name="json_params[style]"
                                                                                        ...
                                                                                        @foreach ($blocks as $item_block)
                                                                                            @if ($item_block->block_code == $items->block_code)
                                                                                                @php
                                                                                                ...
                                                                                                @isset($json_params->style)
                                                                                                    @foreach ($json_params->style as $name => $value)
                                                                                                        <option
                                                                                                            value="{{ $value }}"
                                                                                                            {{ isset($items->json_params->style) && $value == $items->json_params->style ? 'selected' : '' }}>
                                                                                                            {{ __($value) }}
                                                                                                        </option>
                                                                                                    @endforeach
                                                                                                @endisset
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        <span class="input-group-btn">
                                                                                            <a data-input="image-{{ $items->id }}"
                                                                                                data-preview="image-holder-{{ $items->id }}"
                                                                                                class="btn btn-primary lfm"
                                                                                                data-type="cms-image">
                                                                                                <i
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        <span class="input-group-btn">
                                                                                            <a data-input="image_background-{{ $items->id }}"
                                                                                                data-preview="image_background-holder-{{ $items->id }}"
                                                                                                data-type="cms-image"
                                                                                                class="btn btn-primary lfm">
                                                                                                <i
                                                                                                    class="fa fa-picture-o"></i>
                                                                                        ...
                                                                                        <input
                                                                                            id="image_background-{{ $items->id }}"
                                                                                            class="form-control"
                                                                                            type="text"
                                                                                            name="image_background"
                                                                                            placeholder="@lang('Image source')"
                                                                                            value="{{ $items->image_background }}">
                                                                                    </div>
                                                                                    <div id="image_background-holder-{{ $items->id }}"
                                                                                        style="margin-top:15px;max-height:100px;">
                                                                                        @if ($items->image_background != '')
                                                                                            <img style="height: 5rem;"
                                                    ...
                                                    <form
                                                        action="{{ route(Request::segment(2) . '.destroy', $items->id) }}"
                                                ...
                                                <div class="clearfix"></div>
                                                @php
                                                    $block_childs = $parents_child->filter(function ($item, $key) use ($items) {
                                                        return $item->parent_id == $items->id;
                                                    });
                                                @endphp
                                                @if ($block_childs)
                                                    <ol class="dd-list ">
                                                        @foreach ($block_childs as $item_sub_1)
                                                            {{-- @if ($item_sub_1->parent_id == $item->id) --}}
                                                            <li class="dd-item dd3-item" data-id="{{ $item_sub_1->id }}">
                                                                <div class="dd-handle dd3-handle">
                                                                </div>
                                                                <div class="dd3-content">
                                                                    <span class="text float-start"
                                                                        data-update="title">{{ ( $item_sub_1->json_params->title->$lang ?? $item_sub_1->title) }}</span>
                                                                    <span class="text float-end">@lang($status[$item_sub_1->status])</span>
                                                                                    ...
                                                                                    <div class="tab-pane active"
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-6">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        ...
                                                                                                        name="title"
                                                                                                        placeholder="@lang('Title')"
                                                                                                        value="{{ old('title') ?? ( $item_sub_1->json_params->title->$lang ?? $item_sub_1->title) }}"
                                                                                                        required>
                                                                                                </div>
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <div class="form-group">
                                                                                                    <label>@lang('Brief')</label>
                                                                                                    <textarea name="brief" class="form-control" rows="5">{{ old('brief') ?? ( $item_sub_1->json_params->brief->$lang ?? $item_sub_1->brief) }}</textarea>
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <div class="form-group">
                                                                                                    <label>@lang('Content')</label>
                                                                                                    <textarea name="content" class="form-control" rows="5">{{ old('content') ?? ( $item_sub_1->json_params->content->$lang ?? $item_sub_1->content) }}</textarea>
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        ...
                                                                                                        name="url_link_title"
                                                                                                        placeholder="@lang('Url redirect title')"
                                                                                                        value="{{ old('url_link_title') ?? ( $item_sub_1->json_params->url_link_title->$lang ?? $item_sub_1->url_link_title) }}">
                                                                                                </div>
                                                                                            </div>
