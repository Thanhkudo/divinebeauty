                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="json_params[description][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]"
                                                class="form-control" rows="5">{{ old('json_params[description][' . $lang != '' ? $lang : $languageDefault->lang_code . ']') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="json_params[brief][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]" class="form-control"
                                                rows="5">{{ old('json_params[brief][' . $lang != '' ? $lang : $languageDefault->lang_code . ']') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea name="json_params[content][{{ $lang != '' ? $lang : $languageDefault->lang_code }}]" class="form-control"
                                                    id="content_vi">{{ old('json_params[content][' . $lang != '' ? $lang : $languageDefault->lang_code . ']') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
