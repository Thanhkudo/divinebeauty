                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <select name="taxonomy" id="taxonomy" class="form-control select2" required>
                                                ...
                                                <?php $__currentLoopData = App\Consts::TAXONOMY; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($key); ?>"
                                                        <?php echo e($key == $detail->taxonomy ? 'selected' : ''); ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="iorder"
                                                placeholder="<?php echo app('translator')->get('iorder'); ?>" value="<?php echo e($detail->iorder); ?>">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="form-control">
                                                ...
                                                <label>
                                                    <input type="radio" name="is_featured" value="0"
                                                        class="ml-15" <?php echo e($detail->is_featured == '0' ? 'checked' : ''); ?>>
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-btn">
                                                    <a data-input="image_background"
                                                        data-preview="image_background-holder" class="btn btn-primary lfm"
                                                        data-type="category">
                                                        <i class="fa fa-picture-o"></i> <?php echo app('translator')->get('choose'); ?>
                                                    </a>
                                                </span>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="json_params[description][<?php echo e($lang != '' ? $lang : $languageDefault->lang_code); ?>]" class="form-control" rows="5"><?php echo e($detail->json_params->description->$lang ?? old('json_params[description]['.$lang != "" ? $lang : $languageDefault->lang_code.']')); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label><?php echo app('translator')->get('Brief'); ?></label>
                                            <textarea name="json_params[brief][<?php echo e($lang != '' ? $lang : $languageDefault->lang_code); ?>]" class="form-control" rows="5"><?php echo e($detail->json_params->brief->$lang ?? old('json_params[brief]['.$lang != "" ? $lang : $languageDefault->lang_code.']')); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea name="json_params[content][<?php echo e($lang != '' ? $lang : $languageDefault->lang_code); ?>]" class="form-control" id="content_vi"><?php echo e($detail->json_params->content->$lang ?? old('json_params[content]['.$lang != "" ? $lang : $languageDefault->lang_code.']')); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\spa\resources\views/admin/pages/cms_taxonomys/edit.blade.php ENDPATH**/ ?>