            ...
            <div class="elementor-element elementor-element-e9e0e8f e-con-full e-con" data-id="e9e0e8f"
                ...
                @if ($block_childs)
                    @foreach ($block_childs as $item)
                        ...
                        <div class="elementor-element {{ $style_child == 'end' ? 'elementor-element-ca5b593' : 'elementor-element-b5fffce' }} e-con-full e-con"
                            data-id="{{ $style_child == 'end' ? 'ca5b593' : 'b5fffce' }}" data-element_type="container" data-settings='{"content_width":"full"}'>
                            <div class="elementor-element elementor-element-47cc039 e-con-full e-con" data-id="47cc039"
                                ...
                                <div class="elementor-element elementor-element-27145fa elementor-widget elementor-widget-heading"
                                    ...
                                    <div class="elementor-widget-container">
                                        <span
                                            class="elementor-heading-title elementor-size-default">{{ $title_child }}</span>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <ul class="elementor-icon-list-items elementor-inline-items">
                                            <li class="elementor-icon-list-item elementor-inline-item">
                                                <span class="elementor-icon-list-icon">
                                                    @if ($icon_child != '')
                                                        <i aria-hidden="true" class="{{ $icon_child }}"></i>
                                                    @endif
                                                </span>
                                                <span class="elementor-icon-list-text">{{ $content_child }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
